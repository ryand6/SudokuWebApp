...
import { ClassicModeRulesModel } from "./ClassicModeRulesModel";
...
export function ClassicModeCard({
    ...
    return (
        <>
            ...
            <Modal className="max-w-[650px]" isOpen={isRulesModelOpen} onClose={() => setRulesModalOpen(false)}><ClassicModeRulesModel iconSize={iconSize} /></Modal>
        </>
    )
}