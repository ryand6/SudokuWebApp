            ...
            <div className="grid grid-cols-9 grid-rows-9 w-200 h-200">
                {playerGameState.boardState.map((row, r) =>
                    row.map((cell, c) => {
                        ...
                        const borderTop = r % 3 === 0 ? "border-t-4 border-black" : "border-t-2";
                        const borderLeft = c % 3 === 0 ? "border-l-4 border-black" : "border-l-2";
                        const borderBottom = r === 8 ? "border-b-4 border-black" : "";
                        const borderRight = c === 8 ? "border-r-4 border-black" : "";
