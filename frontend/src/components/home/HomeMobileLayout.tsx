...
export function HomeMobileLayout({
    ...
    return (
        <div className="flex flex-col w-full h-full font-display">
            <div className="flex flex-col h-[40%] min-h-[200px] w-full bg-card border-b-2 border-muted items-center justify-center gap-5 px-10 py-5">
            ...
            <div className="flex flex-col w-full h-[30%] min-h-[150px] bg-background py-5 px-10 gap-4 justify-evenly">
