    ...
    return (
        <div className="flex flex-col h-screen">
            ...
            <div id="dashboard-content" className="flex flex-1">
                <div id="actions-pane" className="p-[15px] m-[15px] bg-card border-[2px] rounded-md h-1/3 flex flex-col w-1/4 box-shadow">
                    <h2>Lobby Actions</h2>
                ...
                <div id="mini-leaderboard" className="p-[15px] m-[15px] bg-card border-[2px] rounded-md h-1/3 flex flex-col w-1/4 box-shadow">
                    <h3>Top 5 Players</h3>
                    <ol>
