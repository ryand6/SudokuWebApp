...
*/
public class GameServiceIntegrationTests extends AbstractIntegrationTest {
...
//        when(sudokuPuzzleService.generatePuzzle(difficulty))
//                .thenReturn(List.of(generatedPuzzle, solution));
//
//        GameDto response = gameService.createGame(testLobby);
//
